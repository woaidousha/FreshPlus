...
/**
 * Discovery class for receiving {@link android.content.Intent}s from the network.
 *
...
public class Discovery {
    ...
    /**
     * Create a new {@link com.androidzeitgeist.ani.discovery.Discovery} instance that will listen to the default
     * multicast address and port for incoming {@link android.content.Intent}s.
     */
    public Discovery() {
        this(
    ...
    /**
     * Create a new {@link com.androidzeitgeist.ani.discovery.Discovery} instance that will listen to the default
     * multicast address and the given port for incoming {@link android.content.Intent}s.
     *
    ...
    /**
     * Create a new {@link com.androidzeitgeist.ani.discovery.Discovery} instance that will listen to the given
     * multicast address and port for incoming {@link android.content.Intent}s.
     *
     ...
     * incoming {@link android.content.Intent}s.
     *
    ...
    /**
     * Enables the {@link com.androidzeitgeist.ani.discovery.Discovery} so that it will monitor the network for
     * {@link android.content.Intent}s and notify the given {@link DiscoveryListener} instance.
     *
    ...
    /**
     * Enables the {@link com.androidzeitgeist.ani.discovery.Discovery} so that it will monitor the network for
     * {@link android.content.Intent}s and notify the set {@link DiscoveryListener} instance.
     *
     * @throws DiscoveryException
     * @throws {@link IllegalStateException} if no listener has been set
     * @throws IllegalAccessError if this {@link com.androidzeitgeist.ani.discovery.Discovery} is already enabled
     */
    ...
    /**
     * Disables the {@link com.androidzeitgeist.ani.discovery.Discovery}.
     *
     * @throws IllegalAccessError if this {@link com.androidzeitgeist.ani.discovery.Discovery} is not running
     */
    public void disable() {
        if (thread != null) {
