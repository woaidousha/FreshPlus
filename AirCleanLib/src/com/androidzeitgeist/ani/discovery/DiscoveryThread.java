...
/**
 * Internal class for handling the network connection of the {@link com.androidzeitgeist.ani.discovery.Discovery} class
...
class DiscoveryThread extends Thread {
     ...
     *
     * Do not instantiate this class yourself. Use the {@link com.androidzeitgeist.ani.discovery.Discovery} class
     * instead.
     *
    ...
    protected void receiveIntents() throws IOException {
        while (running) {
            ...
            listener.onIntentDiscovered(packet.getAddress(), intentUri);
        }
    }
}
